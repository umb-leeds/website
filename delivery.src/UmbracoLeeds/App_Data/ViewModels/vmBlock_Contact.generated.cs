...
namespace YuzuDelivery.ViewModels
{
    ...
    [YuzuMap("Contact")]
    public partial class vmBlock_Contact 
    {
        [Newtonsoft.Json.JsonProperty("formIntro", Required = Newtonsoft.Json.Required.DisallowNull, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        ...
        [Newtonsoft.Json.JsonProperty("contactOptions", Required = Newtonsoft.Json.Required.DisallowNull, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public System.Collections.Generic.List<vmSub_ContactContactOption> ContactOptions { get; set; }
    
        [Newtonsoft.Json.JsonProperty("mapHTML", Required = Newtonsoft.Json.Required.DisallowNull, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
    ...
    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "10.0.23.0 (Newtonsoft.Json v12.0.0.0)")]
    [YuzuMap("ContactContactOption")]
    public partial class vmSub_ContactContactOption 
    {
        ...
        [Newtonsoft.Json.JsonProperty("openingTimes", Required = Newtonsoft.Json.Required.DisallowNull, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
