...
namespace YuzuDelivery.ViewModels
{
    ...
    [YuzuMap("DataDate")]
    public partial class vmBlock_DataDate 
    {
        ...
        [Newtonsoft.Json.JsonProperty("monthYear", Required = Newtonsoft.Json.Required.DisallowNull, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
